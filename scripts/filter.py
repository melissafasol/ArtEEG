...
class NoiseFilter:
    ...
    def power_calc_noise(self, bandpass_filtered_data, slope_thresh, int_thresh, clean_br, br_number):
        ...
        #create a list of indices that is equal to 0 for clean epoch and 5 for noisy epoch
...
def remove_seizure_epochs(br_normal, seizure_br):
    #return the indices that are equal to the seizure times and change the brain state values to seizure br state (i.e 4)
